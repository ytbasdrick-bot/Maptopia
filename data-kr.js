...
const resourcesData = {
    ...
    "거대한 나무": { icon: "resource/grand arbre.png", positions: [[-612, 424.5], [-641.8, 369], [-351, 329.5], [-414.3, 337.1], [-396.3, 608.9], [-376.3, 624], [-616, 593.6], [-672.3, 642]] },
    "미끄러운 오크 목재": { icon: "resource/bois de chaine glissant.png", positions: [[-532, 787.3]] },
